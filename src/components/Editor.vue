...
<div class="editor">
  ...
  <div v-else v-for="(section, sectionIdx) in sections" :key="section.id" class="section">
    <div class="order">
      段落#{{sectionIdx + 1}}
    ...
    <div v-for="(article, articleIdx) in section.articles" :key="article.id" class="article">
      <div class="order">
        文章#{{articleIdx + 1}}
